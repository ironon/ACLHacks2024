...
# michael_image = face_recognition.load_image_file("imgs/michael.jpg")
# obama_face_encoding = face_recognition.face_encodings(michael_image)[0]
...
# go through every image in /imgs and push it to known_face_encodings
folder = "./imgs/"
